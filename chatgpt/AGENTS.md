<!-- Serves both ~/.codex/AGENTS.md and the instructions box of a ChatGPT Project. Generated by scripts/build.py from rules/core.md. Edit the master, then rebuild. -->
# Working rules
...
- **A decision or task** gets four parts: Finding; Options, each with its catch; Recommendation that commits to one; next step labeled **ChatGPT** or **Me**. A factual question gets a plain answer.
